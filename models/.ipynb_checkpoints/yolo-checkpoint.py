...
class DetectionModel(BaseModel):
    ...
    def _forward_augment(self, x):
        ...
        #s = [1, 1, 1, 1, 0.83, 0.83, 0.83, 0.83, 1.1, 1.1, 1.1, 1.1]  # scales
        #f = [None, 3, 2, 4, None, 3, 2, 4, None, 3, 2, 4]  # flips (2-ud, 3-lr)
        ...
        for si, fi in zip(s, f):
            if fi == 4:
                xi = scale_img(x.flip(2).flip(3) if fi else x, si, gs=int(self.stride.max()))
                #print('double flipped')
            else:
